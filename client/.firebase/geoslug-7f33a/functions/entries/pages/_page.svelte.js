...
const FilterPanel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="${escape(null_to_empty(open ? "" : "hidden"), true) + " s-s50Bl-jjbF1o"}"${add_attribute(
    ...
    "",
    0
  )}${add_attribute("this", panelParent, 0)}><hr class="only-phone s-s50Bl-jjbF1o"> <button id="close" class="exclude-phone s-s50Bl-jjbF1o"><img src="/icons/close.svg" alt=""></button> <h1 class="s-s50Bl-jjbF1o" data-svelte-h="svelte-1l1t1r">Filter Settings</h1> <section id="hot" class="s-s50Bl-jjbF1o"><h2 class="s-s50Bl-jjbF1o" data-svelte-h="svelte-1yqvi5j">Hotspot Type</h2> <div id="selection-parent" class="s-s50Bl-jjbF1o"><div id="background" class="${escape(null_to_empty(configuration.pointFog ? "" : "alt"), true) + " s-s50Bl-jjbF1o"}"></div> <button class="s-s50Bl-jjbF1o" data-svelte-h="svelte-37ml87">Default</button> <button class="s-s50Bl-jjbF1o" data-svelte-h="svelte-108ec05">Point</button></div></section> <section id="animal" class="s-s50Bl-jjbF1o"><h2 class="s-s50Bl-jjbF1o" data-svelte-h="svelte-1ojql8r">Visible Animals</h2> <div id="selection-parent" class="s-s50Bl-jjbF1o"><button class="${escape(configuration.slug ? "active" : "", true) + " " + escape(configuration.deer ? "square-bottom" : "", true) + " s-s50Bl-jjbF1o"}">Banana Slug</button> <button class="${escape(configuration.deer ? "active" : "", true) + " " + escape(configuration.slug ? "square-top" : "", true) + " " + escape(configuration.tkey ? "square-bottom" : "", true) + " s-s50Bl-jjbF1o"}">Deer</button> <button class="${escape(configuration.tkey ? "active" : "", true) + " " + escape(configuration.deer ? "square-top" : "", true) + " " + escape(configuration.coyo ? "square-bottom" : "", true) + " s-s50Bl-jjbF1o"}">Turkey</button> <button class="${escape(configuration.coyo ? "active" : "", true) + " " + escape(configuration.tkey ? "square-top" : "", true) + " " + escape(configuration.racc ? "square-bottom" : "", true) + " s-s50Bl-jjbF1o"}">Coyote</button> <button class="${escape(configuration.racc ? "active" : "", true) + " " + escape(configuration.coyo ? "square-top" : "", true) + " s-s50Bl-jjbF1o"}">Raccoon</button></div></section> </main>`;
});
const css$1 = {
  code: '@media screen and (min-width: 621px){.only-phone.s-NPdjPyvq7OjS.s-NPdjPyvq7OjS{display:none !important}}@media screen and (max-width: 621px){.exclude-phone.s-NPdjPyvq7OjS.s-NPdjPyvq7OjS{display:none !important}}@media screen and (min-width: 1000px){.exclude-desktop.s-NPdjPyvq7OjS.s-NPdjPyvq7OjS{display:none !important}}@media screen and (max-width: 1000px){.only-desktop.s-NPdjPyvq7OjS.s-NPdjPyvq7OjS{display:none !important}}.glass-heavy.s-NPdjPyvq7OjS.s-NPdjPyvq7OjS,.glass-light.s-NPdjPyvq7OjS.s-NPdjPyvq7OjS{backdrop-filter:blur(40px) saturate(200%);-webkit-backdrop-filter:blur(40px) saturate(200%)}@keyframes s-NPdjPyvq7OjS-fadeIn{from{filter:opacity(0) blur(15px)}to{filter:opacity(1) blur(15px)}}button.s-NPdjPyvq7OjS.s-NPdjPyvq7OjS{font-family:"Outfit", system-ui, Helvetica, sans-serif;touch-action:manipulation;border:none;background-color:hsl(240, 4%, 9%);border-radius:10px;font-size:16px;font-weight:400;color:hsl(0, 0%, 100%);background:none;letter-spacing:-0.44px;padding:6px 16px;margin:0;box-sizing:border-box;cursor:pointer;-webkit-tap-highlight-color:transparent;-webkit-user-drag:none;-moz-user-select:none;user-select:none;-webkit-user-select:none;-ms-user-select:none}main.s-NPdjPyvq7OjS.s-NPdjPyvq7OjS{width:500px;height:fit-content;padding:14px 18px 20px 18px;box-sizing:border-box;border-radius:14px;position:fixed;bottom:20px;right:80px;overflow:hidden;display:flex;justify-content:flex-start;align-items:center;flex-direction:column;background-color:hsl(240, 4%, 9%);z-index:2;transition:transform 700ms cubic-bezier(0.3, 1, 0.22, 1.003)}main.s-NPdjPyvq7OjS .post.s-NPdjPyvq7OjS{width:100%;margin-top:20px;display:flex;flex-direction:column}main.s-NPdjPyvq7OjS .post #content.s-NPdjPyvq7OjS{display:flex}main.s-NPdjPyvq7OjS .post #content img.s-NPdjPyvq7OjS{min-width:200px;width:200px;min-height:200px;height:200px;border-radius:8px;object-fit:cover}main.s-NPdjPyvq7OjS .post #content #desc.s-NPdjPyvq7OjS{display:flex;flex-direction:column;justify-content:center;align-items:flex-start;margin-left:25px}main.s-NPdjPyvq7OjS .post #content #desc h2.s-NPdjPyvq7OjS{font-weight:600;font-size:32px;color:hsl(0, 0%, 93%);letter-spacing:-0.6px}main.s-NPdjPyvq7OjS .post #content #desc h2.red.s-NPdjPyvq7OjS{color:hsl(0, 89%, 61%)}main.s-NPdjPyvq7OjS .post #content #desc h2.blue.s-NPdjPyvq7OjS{color:hsl(238, 83%, 63%)}main.s-NPdjPyvq7OjS .post #content #desc h2.green.s-NPdjPyvq7OjS{color:hsl(101, 83%, 63%)}main.s-NPdjPyvq7OjS .post #content #desc h2.yellow.s-NPdjPyvq7OjS{color:hsl(43, 83%, 63%)}main.s-NPdjPyvq7OjS .post #content #desc h2.orange.s-NPdjPyvq7OjS{color:hsl(20, 90%, 59%)}main.s-NPdjPyvq7OjS .post #content #desc #animal.s-NPdjPyvq7OjS,main.s-NPdjPyvq7OjS .post #content #desc #date.s-NPdjPyvq7OjS{font-weight:400;font-size:16px;color:hsl(0, 0%, 51%);letter-spacing:-0.2px}main.s-NPdjPyvq7OjS .post #content #desc #animal span.s-NPdjPyvq7OjS,main.s-NPdjPyvq7OjS .post #content #desc #date span.s-NPdjPyvq7OjS{color:hsl(0, 0%, 93%)}main.s-NPdjPyvq7OjS .post #content #desc #animal.s-NPdjPyvq7OjS{margin-top:15px}main.s-NPdjPyvq7OjS .post #content #desc #date.s-NPdjPyvq7OjS{margin-top:0px}main.s-NPdjPyvq7OjS .post #rating.s-NPdjPyvq7OjS{width:100%;margin-top:25px}main.s-NPdjPyvq7OjS .post #rating #title.s-NPdjPyvq7OjS{font-weight:500;font-size:15px;color:hsl(0, 0%, 51%);letter-spacing:-0.35px}main.s-NPdjPyvq7OjS .post #rating #button-container.s-NPdjPyvq7OjS{width:100%;height:40px;margin-top:7px;border:1px solid hsl(0, 0%, 18%);border-radius:6px;overflow:hidden;display:flex}main.s-NPdjPyvq7OjS .post #rating #button-container button.s-NPdjPyvq7OjS{width:50%;height:100%;box-sizing:border-box;border-radius:0px;display:flex;justify-content:center;align-items:center}main.s-NPdjPyvq7OjS .post #rating #button-container button.s-NPdjPyvq7OjS:first-child{border-right:1px solid hsl(0, 0%, 18%)}main.s-NPdjPyvq7OjS .post #rating #button-container button.s-NPdjPyvq7OjS:active,main.s-NPdjPyvq7OjS .post #rating #button-container button.s-NPdjPyvq7OjS:hover{background-color:hsl(0, 0%, 18%)}main.s-NPdjPyvq7OjS .post #rating #button-container button:active img.s-NPdjPyvq7OjS,main.s-NPdjPyvq7OjS .post #rating #button-container button:hover img.s-NPdjPyvq7OjS{opacity:0.3}main.s-NPdjPyvq7OjS .post #rating #button-container button.active#yes.s-NPdjPyvq7OjS{background-color:hsl(226, 88%, 58%)}main.s-NPdjPyvq7OjS .post #rating #button-container button.active#yes img.s-NPdjPyvq7OjS{opacity:1}main.s-NPdjPyvq7OjS .post #rating #button-container button.active#no.s-NPdjPyvq7OjS{background-color:hsl(0, 0%, 18%)}main.s-NPdjPyvq7OjS .post #rating #button-container button.active#no img.s-NPdjPyvq7OjS{opacity:0.5}main.s-NPdjPyvq7OjS .post #rating #button-container button img.s-NPdjPyvq7OjS{height:13px;opacity:0.2}main.s-NPdjPyvq7OjS hr.s-NPdjPyvq7OjS{width:36px;height:5px;border-radius:10px;background-color:hsl(0, 0%, 18%);margin-bottom:15px}main.s-NPdjPyvq7OjS #close.s-NPdjPyvq7OjS{position:absolute;top:10px;right:0px;opacity:0.5;border-radius:100px}main.s-NPdjPyvq7OjS #close.s-NPdjPyvq7OjS:hover{opacity:1}main.s-NPdjPyvq7OjS h1.s-NPdjPyvq7OjS{width:100%;text-align:left;font-weight:600;font-size:28px;color:hsl(0, 0%, 93%);letter-spacing:-0.7px}main.hidden.s-NPdjPyvq7OjS.s-NPdjPyvq7OjS{transform:translateY(calc(100% + 75px))}@media screen and (max-width: 621px){main.s-NPdjPyvq7OjS.s-NPdjPyvq7OjS{width:calc(100% - 40px);height:295px;left:20px}main.hidden.s-NPdjPyvq7OjS.s-NPdjPyvq7OjS{transform:translateY(370px)}main.s-NPdjPyvq7OjS .post.s-NPdjPyvq7OjS{margin-top:20px}main.s-NPdjPyvq7OjS .post #content img.s-NPdjPyvq7OjS{min-width:110px;width:110px;min-height:110px;height:110px}main.s-NPdjPyvq7OjS .post #content #desc.s-NPdjPyvq7OjS{margin-left:17px}main.s-NPdjPyvq7OjS .post #content #desc h2.s-NPdjPyvq7OjS{font-size:24px}main.s-NPdjPyvq7OjS .post #content #desc #animal.s-NPdjPyvq7OjS{margin-top:7px}main.s-NPdjPyvq7OjS .post #content #desc #date.s-NPdjPyvq7OjS{margin-top:0px}main.s-NPdjPyvq7OjS .post #rating.s-NPdjPyvq7OjS{margin-top:20px}}',
  map: null
};
const PostPanel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="${escape(null_to_empty(open ? "no-drag" : "no-drag hidden"), true) + " s-NPdjPyvq7OjS"}"${add_attribute(
    ...
    "",
    0
  )}${add_attribute("this", panelParent, 0)}><hr class="only-phone s-NPdjPyvq7OjS"> <button id="close" class="exclude-phone s-NPdjPyvq7OjS"><img src="/icons/close.svg" alt="" class="s-NPdjPyvq7OjS"></button> <h1 class="s-NPdjPyvq7OjS" data-svelte-h="svelte-mc6tbf">Spotted Animal</h1> ${postData ? `<section class="post s-NPdjPyvq7OjS"><section id="content" class="s-NPdjPyvq7OjS"><img${add_attribute("src", postData.image_url, 0)} alt="animal" class="s-NPdjPyvq7OjS"> <section id="desc" class="s-NPdjPyvq7OjS"><h2 id="name" class="${escape(null_to_empty(speciesColor[postData.type]), true) + " s-NPdjPyvq7OjS"}">${escape(postData.count)} ${escape(speciesName[postData.type][Math.min(postData.count - 1, 1)])}</h2>  <p id="animal" class="s-NPdjPyvq7OjS">Spotted by <span class="s-NPdjPyvq7OjS">${escape(postData.name)}</span></p> <p id="date" class="s-NPdjPyvq7OjS">${Math.round(Math.abs(Date.now() / 1e3 - postData.timestamp) / (60 * 60 * 24)) === 0 ? `<span class="s-NPdjPyvq7OjS" data-svelte-h="svelte-olbwrp">Today</span>` : `${Math.round(Math.abs(Date.now() / 1e3 - postData.timestamp) / (60 * 60 * 24)) === 1 ? `<span class="s-NPdjPyvq7OjS" data-svelte-h="svelte-4rug0j">1</span> day ago` : `<span class="s-NPdjPyvq7OjS">${escape(Math.round(Math.abs(Date.now() / 1e3 - postData.timestamp) / (60 * 60 * 24)))}</span> days ago`}`}</p></section></section> <section id="rating" class="s-NPdjPyvq7OjS"><h2 id="title" class="s-NPdjPyvq7OjS" data-svelte-h="svelte-10drvqp">Is this submission accurate?</h2> <div id="button-container" class="s-NPdjPyvq7OjS"><button id="yes" class="${escape(null_to_empty(currentPostRating === "1" ? "active" : ""), true) + " s-NPdjPyvq7OjS"}"><img src="/icons/thumbsup.svg" alt="" class="s-NPdjPyvq7OjS"></button> <button id="no" class="${escape(null_to_empty(currentPostRating === "-1" ? "active" : ""), true) + " s-NPdjPyvq7OjS"}"><img src="/icons/thumbsdown.svg" alt="" class="s-NPdjPyvq7OjS"></button></div></section></section>` : ``} </main>`;
});
const css = {
  code: "@media screen and (min-width: 621px){}@media screen and (max-width: 621px){}@media screen and (min-width: 1000px){}@media screen and (max-width: 1000px){}@keyframes s-y_bCXRrkrYfP-fadeIn{from{filter:opacity(0) blur(15px)}to{filter:opacity(1) blur(15px)}}main.s-y_bCXRrkrYfP.s-y_bCXRrkrYfP{width:100%;height:100vh;overflow:hidden;display:flex;justify-content:center;align-items:center}main.s-y_bCXRrkrYfP #map-container.s-y_bCXRrkrYfP{width:100%;height:100%;position:fixed}main.s-y_bCXRrkrYfP #map-container #map-gradient.s-y_bCXRrkrYfP{background-image:linear-gradient(180deg, hsl(0, 0%, 13%) 0%, hsla(0, 0%, 13%, 0) 100%);position:fixed;width:100%;height:50px;top:0px;pointer-events:none;z-index:1;opacity:0}main.s-y_bCXRrkrYfP #map-container #map.s-y_bCXRrkrYfP{width:100%;height:calc(100vh + 40px);z-index:0;transition:transform 700ms cubic-bezier(0.3, 1, 0.22, 1.003)}@media screen and (max-width: 621px){main.s-y_bCXRrkrYfP.s-y_bCXRrkrYfP{height:calc(100vh - 85px)}main.s-y_bCXRrkrYfP #map-container #map.s-y_bCXRrkrYfP{height:calc(100vh - 40px)}main.s-y_bCXRrkrYfP #map-container #map-gradient.s-y_bCXRrkrYfP{opacity:1}}",
  map: null
};
const speciesColor = {
  slug: "yellow",
